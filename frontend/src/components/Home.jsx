      ...
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <section className="text-center py-20">
          ...
          <p className="text-gray-500">
            Master AI, Web Development, and Programming with industry-focused courses designed to help you build real-world skills.
          </p>
              <div className="mt-8">
                <Link
                  to="/courses"
                  className="bg-green-500 text-white py-3 px-6 rounded font-semibold hover:bg-white hover:text-black duration-300"
                >
                  Explore Courses
                </Link>
              </div>
